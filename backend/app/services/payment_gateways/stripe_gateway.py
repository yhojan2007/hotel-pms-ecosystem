"""Adaptador de payload/URL para Stripe Checkout (demo, sin HTTP real)."""
...
class StripePaymentGateway(BasePaymentGateway):
    """Estructura de Checkout Session y eventos Stripe."""

    def create_payment_link(self, booking_id: int, monto: float, descripcion: str) -> Dict[str, Any]:
        """Devuelve una URL de Checkout de ejemplo."""
    ...
    def parse_webhook_payload(
        ...
        """Lee ``metadata.booking_id`` y ``amount_total`` (centavos → unidades)."""
